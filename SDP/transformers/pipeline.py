...
from SDP.transformers.asr import ASR_Offine_Wrapper
from SDP.transformers.diarization import Speaker_Diarization_Offline
...
class Pipeline(object):
    ...
    def forward(
        self,
        audio_path: str = "examples/part1/bacsidatnhkhoavitadoc_1.wav",
        ...
        try:
            ...
            asr_results = self._asr.forward(
                audio,
                speech_timestamps=[
                    {"start": ele["start"], "end": ele["end"]} for ele in segments
                ],
            )
